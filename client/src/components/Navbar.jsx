    ...
    <div className='flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6'>
      <div className='lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px]
       bg-[#1c1c24] rounded-[100px]'>
        <input type="text" placeholder="search for projects" className='flex w-full font-sans font-normal text-[14px] 
              ...
              <ul className='mb-4'>
                {navlinks.map((link) => (
                  <li key= {link.name}
                    ...
                    <p className={`ml-[20px] font-sans font-semibold text-[14px] 
